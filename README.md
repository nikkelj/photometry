...
- **Altitude visibility envelope**: co-alt and below-shell lines of
  ...
  in-shell Starlinks at catalog altitudes. `FleetScenario.orbit()`
  flies those altitudes; published fleet numbers use the explicit
  620 km / 70° torus (`scenarios.study_orbit()` /
  `orbit(study_torus=True)`). Check with
